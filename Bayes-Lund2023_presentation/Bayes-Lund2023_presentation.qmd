...
:::{.notes}
need for decisions is why we are asked to develop models
:::
...
:::{.notes}
 - multi-stage, or preposterior decision making
...
:::{.notes}
 - how much should we be willing to pay to measure occupancy?
 - scales with time...
 - VoPI
:::
...
:::{.notes}
 - importance of prior
 - imperfect information => Bayesian updating
:::
...
:::{.notes}
analogy to priot predictive sampling
:::
